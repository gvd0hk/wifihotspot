        ...
        <aside class="nav-wrap" id="site-nav" data-perfect-scrollbar>
            ...
            <nav class="site-nav clearfix" role="navigation">
                ...
                <ul class="list-unstyled clearfix nav-list mb15">
                    <li {if $_system_menu eq 'dashboard' }class="active" {/if}> <a href="{$_url}dashboard">
                        <i class="ion ion-monitor"></i>
                        <span class="text">{$_L['Dashboard']}</span>
                        </a>
                    </li>
                    <!-- <li {if $_system_menu eq 'message' }class="open" {/if}> <a href="#">
                    ...
                    {if $_admin['user_type'] eq 'Admin' || $_admin['user_type'] eq 'Sales'}
                    <li {if $_system_menu eq 'customers' }class="open" {/if}> <a href="#">
                    ...
                    <li {if $_system_menu eq 'prepaid' }class="open" {/if}> <a href="#">
                    ...
                    <li {if $_system_menu eq 'services' }class="open" {/if}> <a href="#">
                    ...
                    <li {if $_system_menu eq 'reports' }class="open" {/if}> <a href="#">
                    ...
                    {else}
                    <li {if $_system_menu eq 'voucher' }class="open" {/if}> <a href="#">
                        <i class="ion ion-card"></i>
                    ...
                    <li {if $_system_menu eq 'order' }class="active" {/if}> <a href="{$_url}order">
                        <i class="ion ion-ios-cart"></i>
                        <span class="text">{$_L['Order_Voucher']}</span>
                        </a>
                    </li>
                    <li {if $_system_menu eq 'accounts' }class="open" {/if}> <a href="#">
                    ...
                    <li {if $_system_menu eq 'network' }class="open" {/if}> <a href="#">
                    ...
                    <li {if $_system_menu eq 'settings' }class="open" {/if}> <a href="#">
                        <i class="ion ion-gear-a"></i>
